    ...
    return (
        <Template {...{ kcContext, i18n, doUseDefaultCss, classes }} headerNode={msg("registerTitle")}>
            <form id="kc-register-form" className={getClassName("kcFormClass")} action={url.registrationAction} method="post">
                ...
                <div
                    className={clsx(getClassName("kcFormGroupClass"), messagesPerField.printIfExists("dob", getClassName("kcFormGroupErrorClass")))}
                >
                    <div className={getClassName("kcLabelWrapperClass")}>
                        <label htmlFor="dob" className={getClassName("kcLabelClass")}>
                            {msg("birthday")}
                        </label>
                    </div>
                    <div className={getClassName("kcInputWrapperClass")}>
                        <input
                            ...
                            className={getClassName("kcInputClass")}
                            name="dob"
                            defaultValue={register.formData.dob ?? ""}
                            autoComplete="dob"
                        />
                    </div>
                </div>
                ...
                <div
                    className={clsx(getClassName("kcFormGroupClass"), messagesPerField.printIfExists("mobile", getClassName("kcFormGroupErrorClass")))}
                >
                    <div className={getClassName("kcLabelWrapperClass")}>
                        <label htmlFor="mobile" className={getClassName("kcLabelClass")}>
                            {msg("phoneNumber")}
                        </label>
                    </div>
                    <div className={getClassName("kcInputWrapperClass")}>
                        <input
                            ...
                            className={getClassName("kcInputClass")}
                            name="mobile"
                            defaultValue={register.formData.mobile ?? "+91"}
                            autoComplete="mobile"
                        />
                    </div>
                </div>
